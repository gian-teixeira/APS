class Feedback:
    def __init__(self, star_rating : int, written_rating : str, date_menu : str, period_menu : str, id_student : str):
        ...
        self.id = f'{date_menu} - {period_menu}' # TODO: olhar como os feedbacks serao buscados
        self.id_student = id_student # TODO: a gente vai associar o feedback ao aluno? Como vamos deletar um feedback? Aí ferrou tude
